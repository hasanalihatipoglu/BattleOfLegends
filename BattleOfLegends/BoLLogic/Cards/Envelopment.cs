...
public class Envelopment(PlayerType faction) : Card
{
    public override CardType Type => CardType.Envelopment;
    ...
    public override bool IsValid()
    {
        ...
        foreach (Tile tile in target.Tile.Adjacents)
        {
            if (tile != null && tile.Unit != null)
            {
                ...
                {
                    if (tile.Unit.Abilities.Contains(CardType.Flanking) == true)
                    {
                        numberOfFlankingUnits++;                      
                    }
    ...
    public override bool Play()
    {
        ...
        if (IsValid())
        {
            CombatManager.Instance.DiceModifier = numberOfFlankingUnits;
            return true;
        }
        else
        {
